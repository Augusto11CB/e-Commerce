...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    /**
     * This method is originally present in the parent of the Base class. After overriding, this method will be called
     * after a user logs in successfully. Below, it is generating a String token (JWT) for this user.
     */
    @Override
